//! SPI NOR Flash driver for RP2040
//! Uses hardware SPI peripheral for high-speed communication with SPI NOR flash chips
//! 
...
//! 
//! Requirements: 9.1, 1.1, 2.1, 2.2, 3.1, 4.1
...
impl<'d, SPI: embassy_rp::spi::Instance> SpiNorController<'d, SPI> {
    ...
    /// 
    /// Reads data at higher clock speeds (up to 133MHz depending on chip).
