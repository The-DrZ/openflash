//! SPI NAND Flash driver for STM32F1
//! Uses hardware SPI peripheral for communication
...
/// SPI NAND controller for STM32F1
pub struct SpiNandController<'d, SPI: embassy_stm32::spi::Instance> {
...
impl<'d, SPI: embassy_stm32::spi::Instance> SpiNandController<'d, SPI> {
