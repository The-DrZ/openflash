//! eMMC Flash driver for STM32F1
//! Uses SPI mode for eMMC communication
...
/// eMMC controller using SPI mode for STM32F1
pub struct EmmcController<'d, SPI: embassy_stm32::spi::Instance> {
...
impl<'d, SPI: embassy_stm32::spi::Instance> EmmcController<'d, SPI> {
    ...
    pub async fn init(&mut self) -> bool {
        ...
        retries = 1000;
        loop {
            let r1 = self.send_cmd(commands::SEND_OP_COND, 0x40000000);
            if r1 == 0x00 {
                break;
            }
            if r1 != r1_status::IDLE_STATE {
